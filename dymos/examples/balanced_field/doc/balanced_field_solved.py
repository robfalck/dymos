...
liftoff_to_climb_gradient.add_boundary_balance(param='t_duration', name='climb_gradient', tgt_val=0.05, loc='final',
                                               lower=0, upper=10)
...
climb_to_obstacle_clearance.add_boundary_balance(param='t_duration', name='h', tgt_val=35, eq_units='ft', loc='final',
...
traj.add_parameter('T_engine_out', val=27000, opt=False, units='lbf', static_target=True,
                ...
                targets={phase: ['T'] for phase in ['vef_to_v1', 'v1_to_vr', 'rotate', 'liftoff_to_climb_gradient',
...
traj_balance_comp.add_balance('v1', units='kn', eq_units='ft', val=130, lower=50, upper=180,
...
traj_balance_comp.add_balance('v_ef', units='kn', eq_units='s', val=80, lower=20, upper=180,
...
#
# Use an analysis driver to sweep over various combinations of initial mass and nominal thrust
#
case_gen = om.ProductGenerator({'traj.parameters:m': {'val': np.linspace(174200 - 500, 174200 + 500, 11),
                                                      'units': 'lbm'},
                                'traj.parameters:T_nominal': {'val': np.linspace(27000. - 500, 27000. + 500, 11),
                                                              'units': 'lbf'}})
