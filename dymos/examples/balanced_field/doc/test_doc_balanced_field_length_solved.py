...
class TestBalancedFieldLengthForDocs(unittest.TestCase):
    ...
    def test_balanced_field_length_solved(self):
        ...
        traj_balance_comp.add_balance('v1', units='kn', eq_units='ft', val=130, lhs_name='r_obstacle', rhs_name='r_rto')
        ...
        traj_balance_comp.add_balance('v_ef', units='kn', eq_units='s', val=80, lhs_name='ef_to_v1_duration', rhs_name='t_react')
