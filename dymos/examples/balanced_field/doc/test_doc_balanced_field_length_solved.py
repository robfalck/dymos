    ...
    def test_balanced_field_length_solved(self):
        ...
        br_to_v1 = dm.Phase(ode_class=BalancedFieldODEComp, transcription=tx,
                            ode_init_kwargs={'mode': 'runway',
                                             ...
                                             'control': 'gam_rate'})
        br_to_v1.set_time_options(fix_initial=True, fix_duration=True, duration_bounds=(1, 1000))
        ...
        v1_balance_comp = om.BalanceComp()
        v1_balance_comp.add_balance('v1', units='kn', eq_units='ft', val=130, lhs_name='r_obstacle', rhs_name='r_rto')
        traj.add_subsystem('v1_balance', v1_balance_comp, promotes_outputs=['v1'])
        traj.connect('rto.final_states:r', 'v1_balance.r_rto')
        traj.connect('climb_to_obstacle_clearance.final_states:r', 'v1_balance.r_obstacle')
        traj.connect('v1', 'br_to_v1.parameters:v1')
        ...
        # Including this as an alternative to the first link_phases call with connected=True
        ...
        liftoff_to_pitch_limit.set_parameter_val('pitch_rate', 2.0, units='deg/s')
