...
class TestBalancedFieldLengthSolved(unittest.TestCase):
    ...
    def test_balance_field_length_solved(self):
        ...
        br_to_v1 = dm.Phase(ode_class=BalancedFieldODEComp, transcription=dm.PicardShooting(num_segments=1, nodes_per_seg=21, solve_segments='forward'),
        ...
        traj.add_parameter('mu_r_nominal', val=0.03, opt=False, units=None, static_target=True,
                           ...
                           targets={'br_to_v1': ['mu_r']})
        #, 'v1_to_vr': ['mu_r'],  'rotate': ['mu_r']})
