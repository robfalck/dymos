...
class GaussLobattoInterpComp(om.ExplicitComponent):
    r"""
    Provide interpolated state values and/or rates for the Gauss-Lobatto transcriptions.

    It accepts the state values and derivatives at discretization nodes and computes the
    interpolated state values and derivatives at the collocation nodes, using a Hermite interpolation scheme.
