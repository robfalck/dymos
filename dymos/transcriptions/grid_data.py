...
class GridData(object):
    ...
    def __init__(self, num_segments, transcription, transcription_order=None,
        ...
        if self.transcription == 'chebyshev-gauss-lobatto':
            get_subsets_nodes_and_weights = chebyshev_gauss_lobatto_subsets_and_nodes
            ...
            raise ValueError(f'unexpected transcription {self.transcription}')
        ...
        for iseg in range(num_segments):
            subsets_i, nodes_i, weights_i = get_subsets_nodes_and_weights(self.transcription_order[iseg],
                                                                          seg_idx=iseg,
